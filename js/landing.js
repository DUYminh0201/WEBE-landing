...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    vi: {
      ...
      feat1_desc: "Giao hàng miễn phí toàn quốc cho hóa đơn từ $150. Đóng gói hộp quà tặng cao cấp bảo vệ sản phẩm tối đa.",
    ...
    en: {
      ...
      feat1_desc: "Free nationwide shipping for orders over $150. Premium gift packaging included for product protection.",
    ...
    km: {
      ...
      feat1_desc: "ដឹកជញ្ជូនឥតគិតថ្លៃទូទាំងប្រទេសសម្រាប់ការបញ្ជាទិញចាប់ពី $150 ឡើងទៅ។ ខ្ចប់ក្នុងប្រអប់កាដូដ៏ប្រណិត។",
